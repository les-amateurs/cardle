...
import { Game, State, IDS, mod, Var, wrap, Vec2, SOUND_EFFECTS } from "./common.tsx";
...
function Cardle({ restart } : {restart: any}) {
        ...
        if (oldGuess.indexOf(undefined) == -1) {
            ...
            if (valid) {
                ...
                const final = JSON.stringify(
                    Array.from(newGreens.keys()).toSorted()
                );
